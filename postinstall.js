...
const commandFile = path.join(commandsDir, "usage.md");
const commandContent = `---
description: OpenCode Go subscription quota and usage check
---

Run the \`opencode_usage\` tool and DISPLAY EXACTLY the text it returns, without modifying, summarizing, adding, or removing anything. Just print the result as-is.
`;
